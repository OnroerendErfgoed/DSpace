...
<xsl:stylesheet
    ...
    <xsl:template name="itemSummaryView-show-full">
        <div class="simple-item-view-show-full item-page-field-wrapper table">
            <h5>
                <i18n:text>xmlui.mirage2-OE.itemSummaryView.MetaData</i18n:text>
            </h5>
            <a>
    ...
    <xsl:template name="itemSummaryView-collections">
        <xsl:if test="$document//dri:referenceSet[@id='aspect.artifactbrowser.ItemViewer.referenceSet.collection-viewer']">
            <div class="simple-item-view-collections item-page-field-wrapper table">
                <h5>
                    <i18n:text>xmlui.mirage2-OE.itemSummaryView.Collections</i18n:text>
                </h5>
            ...
            <xsl:when test="//mets:fileSec/mets:fileGrp[@USE='CONTENT' or @USE='ORIGINAL' or @USE='LICENSE']/mets:file">
                <div class="item-page-field-wrapper table word-break">
                    ...
                    <xsl:variable name="label-1">
                            <xsl:choose>
                                <xsl:when test="confman:getProperty('mirage2-OE.item-view.bitstream.href.label.1')">
                                    <xsl:value-of select="confman:getProperty('mirage2-OE.item-view.bitstream.href.label.1')"/>
                                </xsl:when>
                                <xsl:otherwise>
                    ...
                    <xsl:variable name="label-2">
                            <xsl:choose>
                                <xsl:when test="confman:getProperty('mirage2-OE.item-view.bitstream.href.label.2')">
                                    <xsl:value-of select="confman:getProperty('mirage2-OE.item-view.bitstream.href.label.2')"/>
                                </xsl:when>
                                <xsl:otherwise>
