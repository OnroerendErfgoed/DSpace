            ...
            <title>
                <xsl:choose>
                    <xsl:when test="starts-with($request-uri, 'page/about')">
                        <i18n:text>xmlui.mirage2-OE.page-structure.aboutThisRepository</i18n:text>
                    </xsl:when>
...
<!-- sub nav -->
    ...
    <li><a href="/">home onroerend erfgoed</a></li>
    </ul>
<!-- end sub nav -->
...
<a href="{$context-path}/">
<h1>Open Archief</h1>
<img src="{$theme-path}/images/OE-vlaanderen-logo.png" width="65"></img>
<h2>Vlaanderen</h2>
<h4>is Onroerend Erfgoed</h4>
</a>
                ...
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <button type="button" class="navbar-toggle" data-toggle="offcanvas">
                            <span class="sr-only">
                                <i18n:text>xmlui.mirage2-OE.page-structure.toggleNavigation</i18n:text>
                            </span>
                    ...
                    <div class="navbar-header pull-right hidden-xs">
                        ...
                        <button data-toggle="offcanvas" class="navbar-toggle visible-sm" type="button">
                            <span class="sr-only"><i18n:text>xmlui.mirage2-OE.page-structure.toggleNavigation</i18n:text></span>
                            <span class="icon-bar"></span>
                            <span class="icon-bar"></span>
                            <span class="icon-bar"></span>
                        </button>
        ...
        <footer id="footer-bottom" role="contentinfo">
            <div class="footer-bottom-inner inner">
                <nav class="footer-doormat clearfix">
                        ...
                        <ul>
                           <li> 
                                <a href="http://www.dspace.org/" target="_blank">DSpace software &#160;&#169;&#160;2002-2015&#160;</a> 
                            </li>
                            <li>
    ...
    <xsl:template match="dri:body">
        <div>
            ...
            <xsl:choose>
                <xsl:when test="starts-with($request-uri, 'page/about')">
                    <div class="hero-unit">
                        <h1><i18n:text>xmlui.mirage2-OE.page-structure.heroUnit.title</i18n:text></h1>
                        <p><i18n:text>xmlui.mirage2-OE.page-structure.heroUnit.content</i18n:text></p>
                    </div>
                </xsl:when>
